...
class Helper
{
    ...
    public static function bdwebteam_get_case_study_cat($postID){  

    $terms = wp_get_post_terms( $postID, "bdwebteam-case-studies-cat", array( 'fields' => 'all' ) );
    if(!empty($terms)){ 
    ...
    public static function bdwebteam_get_projects_cat_text($postID){  

    $terms = wp_get_post_terms( $postID, "bdwebteam-projects-category", array( 'fields' => 'all' ) );
    if(!empty($terms)){ 
      foreach($terms as $index =>  $term){  ?>   
    ...
    public static function bdwebteam_get_projects_cat($postID){  
    ...
    public static function file_requires($filename, $dir = false)
    {
        if ($dir) {
            ...
            if (file_exists($child_file)) {
                ...
                $file = BDWEBTEAM__FREAMWORK_DIRECTORY . $filename;
            }
        }
    ...
    public static function the_breadcrumb() {
        if ( function_exists( 'bcn_display') ) {
            ...
            $breadcrumb = new bdwebteamtheme_Breadcrumb( $args );
    ...
    public static function bdwebteam_get_image_alt2( $image_id ){ 
