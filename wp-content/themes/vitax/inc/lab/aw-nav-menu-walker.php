...
if (!class_exists('BdwebteamNavWalker')) {
    class BdwebteamNavWalker extends Walker_Nav_Menu
    {
        ...
        public function start_lvl(&$output, $depth = 0, $args = array())
        {
            ...
            // Default class.
            $classes = array('bdwebteam-submenu department-megamenu');
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
        {
            ...
            $mega_menu_template = '';
            if( class_exists('acf') ) {
                $enable_mega_menu = get_field('vitax_enable_mega_menu', $item);
                $mega_menu_template = get_field('vitax_select_mega_menu', $item);
            }
            global $post;
            ...
            $post_type_class = 'bdwebteam-post-type-' . get_post_type( get_the_ID() );
            ...
            $title = apply_filters( 'bdwebteamtheme_navmenu_icon_item_title', $title, $item, $args, $depth, $this->icon_display , $this->text_display ); 
