    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'name' => 'vitax_category_background_image',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'label' => 'Review Box',
                'name' => 'bdwebteam_post_review_box',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                ...
                'name' => 'bdwebteam_post_review_box_position',
                'type' => 'select',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                ...
                'label' => 'Review Image',
                'name' => 'bdwebteam_post_review_image',
                'type' => 'image',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'label' => 'Review Name',
                'name' => 'bdwebteam_post_review_name',
                'type' => 'text',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'label' => 'Description',
                'name' => 'bdwebteam_post_review_description',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'label' => 'Review Score',
                'name' => 'bdwebteam_post_review_score',
                'type' => 'range',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'label' => 'Summary',
                'name' => 'bdwebteam_post_review_summary',
                'type' => 'textarea',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'label' => 'Pors and Cons',
                'name' => 'bdwebteam_post_review_pors_and_cons',
                'type' => 'true_false',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
            ...
            array(
                ...
                'label' => 'Pors',
                'name' => 'bdwebteam_post_review_pors',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
                ...
                'sub_fields' => array(
                    array(
                        ...
                        'label' => 'Add Pors',
                        'name' => 'bdwebteam_post_review_add_pors',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
            ...
            array(
                ...
                'label' => 'Cons',
                'name' => 'bdwebteam_post_review_cons',
                'type' => 'repeater',
                'instructions' => '',
                'required' => 0,
                'conditional_logic' => array(
                ...
                'sub_fields' => array(
                    array(
                        ...
                        'label' => 'Add Cons',
                        'name' => 'bdwebteam_post_review_add_cons',
                        'type' => 'text',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
