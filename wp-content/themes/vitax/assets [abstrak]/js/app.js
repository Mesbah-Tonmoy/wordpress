(function(window, document, $, undefined) {
    ...
    var bdwebteamInit = {
        ...
        methods: function(e) {
            bdwebteamInit.w();
            bdwebteamInit.contactForm();
            bdwebteamInit.bdwebteamBackToTop();
            bdwebteamInit.stickyHeaderMenu();  
            bdwebteamInit.menuLinkActive(); 
            bdwebteamInit.bdwebteamScrollSpy();
            //bdwebteamInit.onePageNav();
            bdwebteamInit.bdwebteamScrollSpyOnepage();
            bdwebteamInit.blogModalActivation();
            bdwebteamInit.portfolioModalActivation();
            bdwebteamInit.caseModalActivation();
            

        },

        w: function(e) {
            this._window.on('load', bdwebteamInit.l).on('scroll', bdwebteamInit.res)
        },

        contactForm: function() {
            $('.bdwebteam-contact-form').on('submit', function(e) {
                e.preventDefault();
                var _self = $(this);
        ...
        stickyHeaderMenu: function() {
            ...
            $(window).on('scroll', function() {
                ...
                if ($('body').hasClass('sticky-header')) {
                    var stickyPlaceHolder = $("#bdwebteam-sticky-placeholder"),
                        menu = $(".bdwebteam-mainmenu"),
                        menuH = menu.outerHeight(),
                        topHeaderH = $('.bdwebteam-header-top').outerHeight() || 0,
                        targrtScroll = topHeaderH + 200;
                    if ($(window).scrollTop() > targrtScroll) {
                        menu.addClass('bdwebteam-sticky');
                        stickyPlaceHolder.height(menuH);
                    } else {
                        menu.removeClass('bdwebteam-sticky');
        ...
        bdwebteamScrollSpyOnepage: function () {
            ...
            $("#onepagemenu-bdwebteam a[href*=#]:not([href=#])").on('click', function() {
        ...
        caseModalActivation : function () {
            ...
            if ($('body').hasClass('onepage-template')) {
                ...
                caseList.each(function() {
                    ...
                    var $this = $(this);
                    var buttons = $this.find('.bdwebteam-btn');
                    var title = $this.find('.title');
