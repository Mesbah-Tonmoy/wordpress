(function() {
    ...
    var Theme = {
        ...
        countdown: function countdown() {
            if (typeof $.fn.countdown == 'function') {
                try {
                    ...
                    var day = vitaxObj.day == 'Day' ? 'Day%!D' : vitaxObj.day,
                        hour = vitaxObj.hour == 'Hour' ? 'Hour%!D' : vitaxObj.hour,
                        minute = vitaxObj.minute == 'Minute' ? 'Minute%!D' : vitaxObj.minute,
                        second = vitaxObj.second == 'Second' ? 'Second%!D' : vitaxObj.second;
        ...
        bdwebteamMasonary: function() {
            $('.bdwebteam-isotope-wrapper').imagesLoaded(function() {
        ...
        bdwebteamcounterUpAtion: function() {
            var _counter = $('.count');
            if (_counter.length) {
                _counter.counterUp({
                    delay: 10,
     ...
     counterUp: function () {
        ...
        bdwebteamSlickActivation: function(e) {
        ...
        mobileMenuActivation: function(e) {
            ...
            $('.menu-item-has-children > a').on('click', function(e) {
                ...
                var targetParent = $(this).parents('.header-main-nav'),
                    target = $(this).siblings('.bdwebteam-submenu'),
                    targetSiblings = $(this).parent('.menu-item-has-children').siblings().find('.bdwebteam-submenu');
            ...
            function resizeClassAdd() {
                if (window.matchMedia('(min-width: 992px)').matches) {
                    ...
                    $('.bdwebteam-mainmenu .offcanvas-backdrop').remove();
                    $('.bdwebteam-submenu').removeAttr('style');
    ...
    function content_ready_scripts() {
        ...
        Theme.bdwebteamMasonary();
        //Theme.bdwebteamcounterUpAtion();
        Theme.counterUp();
        Theme.bdwebteamSlickActivation();
        Theme.magnificPopupActivation();
        Theme.salActivation();
        Theme.marqueImages();
        Theme.bdwebteamHover();
