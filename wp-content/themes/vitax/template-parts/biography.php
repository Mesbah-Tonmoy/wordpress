    ...
    <div class="author">
        <div class="author-thumb">
           <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ))); ?>">
                <?php
                $bdwebteam_author_bio_avatar_size = apply_filters( 'bdwebteam_author_bio_avatar_size', 80 );
                echo get_avatar( get_the_author_meta( 'user_email' ), $bdwebteam_author_bio_avatar_size );
                ?>
            </a>
        </div>
        <div class="info">
