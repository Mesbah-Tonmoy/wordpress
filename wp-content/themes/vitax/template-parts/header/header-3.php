...
$bdwebteam_enable_offcanvas  = $bdwebteam_options['bdwebteam_enable_offcanvas'];
$bdwebteam_enable_social  = $bdwebteam_options['bdwebteam_enable_menu_social'];
...
<header class="header bdwebteam-header header-style-3">
        ...
        <div class="container">
            <div class="header-navbar">
                ...
                <div class="header-action">
                    ...
                    <?PHP if ( "0" !== $bdwebteam_enable_social):?>  
