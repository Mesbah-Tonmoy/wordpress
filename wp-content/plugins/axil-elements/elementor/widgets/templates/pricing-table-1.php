...
use Elementor\Icons_Manager;
    ...
    if ( $settings['url']['url'] ) {
        $btn = '<a class="axil-btn btn-large-fluid btn-borderd" ' . $attr . '>'.$settings['detail_txt'] .'</a>';
    }
	...
	?>	
    <div class="pricing-table <?php echo esc_attr( $active );?>  <?php echo esc_attr( $hasborder );?> ">
