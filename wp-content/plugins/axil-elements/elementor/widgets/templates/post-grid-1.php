				...
				?>
                    <div class="col-xl-6">
				        ...
				        <div class="post-content">
                                <h5 class="blog-title title"><a href="<?php the_permalink(); ?>"><?php echo esc_attr( $ptitle );?></a></h5>
                               <?php if( $settings['content_display'] ){ ?>
                               		 <p class="blog-content"><?php echo esc_attr( $excerpt );?></p>
                                 <?php } ?> 
                                <?php if( $settings['post_details'] ){ ?>
                                <a href="<?php the_permalink(); ?>" class="more-btn"><?php echo esc_attr( $post_details_text );?><i class="far fa-angle-right"></i></a>
                                <?php } ?>  
                            </div>
                        </div>
                    </div>
