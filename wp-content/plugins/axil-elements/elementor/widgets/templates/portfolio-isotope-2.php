...
if ( !empty( $settings['category_list'] ) ) {
	$args['tax_query'] = array(
		array(
			'taxonomy' => "axil_projects_category",
			'field' => 'term_id',
...
foreach ( $posts as $post ) {
	...
	$terms            = get_the_terms( $post, "axil-projects-category" );
		...
		<?php } ?> 
     	<div class="axil-isotope-wrapper">
			<?php if($settings['filter'] == 'yes'){ ?>		
				...
				<button data-filter="*" class="is-checked"><span class="filter-text"><?php esc_html_e( 'All Works', 'axil-elements' );?></span></button>					
