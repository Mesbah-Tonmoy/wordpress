...
class axil_services_grid_onepage extends Widget_Base {
  use \Elementor\AxilElementCommonFunctions;
    public function get_name() {
        return 'axil-services-grid-onepage';
    }    
    public function get_title() {
        return __('Dynamic - Services Grid OnePage', 'axil-elements' );
    }
 ...
 protected function render() {
        ...
        $template   = 'services-grid-onepage-' . str_replace("layout", "", $settings['layout']);                 
