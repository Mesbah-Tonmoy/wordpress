...
function axil_get_allowed_html_desc($level = 'basic')
{
    ...
    return sprintf(__('This input field has support for the following HTML tags: %1$s', 'axil-elements'), '<code>' . esc_html($tags_str) . '</code>');
}
 ...
 */
trait AxilElementCommonFunctions
{
     ...
     */
    protected function axil_section_title( $control_id = null, $title = 'Your Section Title', $default_title_tag = 'h2', $align_field = false, $align = 'left')
    {
        ...
        $this->add_control(
            'axil_' . $control_id . '_title_before',
            [
                ...
                'condition' => array( 'seation_' . $control_id . '_title_on' => array( 'yes' ) ),       
            ]
        );
     ...
     * @param string $description
     */
    protected function axil_shape_position( $control_id = null, $shapegroup = 'shape-group-12', $control_selector = null )
    {
        
        $this->add_control(
            'axil_' . $control_id . '_pos_x_type',
            [
                'label' => __( 'Horizontal Position', 'axil-elements' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __( 'Left', 'axil-elements' ),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'right' => [
                        'title' => __( 'Right', 'axil-elements' ),
                        'icon'  => 'eicon-h-align-right',
                    ],
                ],
                'default' => 'right',
        ...
        $this->add_responsive_control(      
            'axil_' . $control_id . '_pos_x',
            [
                'label' => __( 'Offset', 'axil-elements' ),
                ...
                'selectors' => [ 
                      '{{WRAPPER}} ' . $control_selector  . ' .shape.ax-pos-left' => 'left: {{SIZE}}{{UNIT}};', 
                      '{{WRAPPER}} ' . $control_selector  . ' .shape.ax-pos-right'     => 'right: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'axil_' . $control_id . '_pos_y_type',
            [
                'label' => __( 'Vertical Position', 'axil-elements' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
                        'title' => __( 'Top', 'axil-elements' ),
                        'icon'  => 'eicon-v-align-top',
                    ],
                    'bottom' => [
                        'title' => __( 'Bottom', 'axil-elements' ),
        ...
        $this->add_responsive_control(      
            ...
            [
                ...
                'selectors' => [              
                     ...
                     '{{WRAPPER}} ' . $control_selector . ' .shape.ax-pos-top' => 'left: {{SIZE}}{{UNIT}};', 
                     '{{WRAPPER}} ' . $control_selector . ' .shape.ax-pos-bottom'     => 'right: {{SIZE}}{{UNIT}};',
                ],
            ]
        ); 
 ...
 /**
    ...
    protected function axil_query_controls($control_id = null, $control_name = null, $post_type = 'any', $taxonomy = 'category', $posts_per_page = '6', $offset = '0', $orderby = 'date', $order = 'desc')
    {
        ...
        $this->start_controls_section(
            'axil-elements' . $control_id . '_query',
            [
                'label' => sprintf(esc_html__('%s Query', 'axil-elements'), $control_name),
            ]
        );
        ...
        $this->add_control(
            'category',
            [
                'label' => esc_html__('Category', 'axil-elements'),
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => esc_html__('Exclude', 'axil-elements'),
                'type' => Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => esc_html__('Posts Per Page', 'axil-elements'),
        ...
        $this->add_control(
            'offset',
            [
                'label' => esc_html__('Offset', 'axil-elements'),
                'type' => Controls_Manager::NUMBER,
                'default' => $offset,
            ]
        );
        $this->add_control(
            'orderby',
            [
                'label' => esc_html__('Order By', 'axil-elements'),
        ...
        $this->add_control(
            'order',
            [
                'label' => esc_html__('Order', 'axil-elements'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' => 'Ascending',
                    'desc' => 'Descending'
     ...
     * @return [type]                 [description]
     */
    protected function axil_blig_query_controls($control_id = null, $control_name = null, $post_type = 'any', $taxonomy = 'category', $posts_per_page = '6', $offset = '0', $orderby = 'date', $order = 'desc')
    {
        ...
        $this->add_control(
            'exclude_category',
            [
                'label' => esc_html__('Exclude Category', 'axil-elements'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
        ...
        $this->add_control(
            ...
            [
                'type'    => Controls_Manager::SELECT2,
                'label'   => esc_html__( 'Select post manually', 'axil-elements' ),
                'label_block' => true,
                'multiple' => true,
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => esc_html__('Exclude post', 'axil-elements'),
                'type' => Controls_Manager::SELECT2,
                'options' => axil_get_all_types_post($post_type),
                'multiple' => true,
                'label_block' => true
        ...
        $this->add_control(
            'post_format',
            [
                'label' =>esc_html__('Select Post Format', 'axil-elements'),
                'type'      => Controls_Manager::SELECT2,
                'options' => [
                    'post-format-standard' => esc_html__( 'Standard', 'axil-elements' ),
                    'post-format-audio' => esc_html__( 'Audio', 'axil-elements' ),
                    'post-format-video' => esc_html__( 'Video', 'axil-elements' ),
                    'post-format-gallery' => esc_html__( 'Gallery', 'axil-elements' ),
                    'post-format-link' => esc_html__( 'Link', 'axil-elements' ),
                    'post-format-quote' => esc_html__( 'Quote', 'axil-elements' ),
                ],
                'default' => [],
                'label_block' => true,
                'multiple'  => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'desc' => esc_html__('Descending', 'axil-elements'),
                ],
                'default' => $order,
        ...
        $this->add_control(
            'ignore_sticky_posts',
            [
                'label' => esc_html__( 'Ignore sticky posts', 'axil-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show only sticky posts', 'axil-elements' ),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'axil-elements' ),
                'label_off' => esc_html__( 'No', 'axil-elements' ),
                'return_value' => 'yes',
    ...
    protected function axil_basic_style_controls($control_id = null, $control_name = null, $control_selector = null)
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__($control_name, 'axil-elements'),
    ...
    protected function axil_section_style_controls($control_id = null, $control_name = null, $control_selector = null)
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Border', 'axil-elements' ),
                'selector' => '{{WRAPPER}} ' . $control_selector,
                'separator' => 'before',
            ]
        );
     ...
     * @return [type]               [description]
     */
    protected function axil_link_controls($control_id = 'button', $control_name = 'Button', $default = 'Read More', $archive = false )
    {

        $this->add_control(
            'axil_' . $control_id . '_show',
            [
                'label' => esc_html__('Show Button', 'axil-elements'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'axil-elements'),
                'label_off' => esc_html__('Hide', 'axil-elements'),
                'return_value' => 'yes',
                'default' => 'no',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Text', 'axil-elements'),
                'type' => Controls_Manager::TEXT,
                'default' => $default,
                'title' => esc_html__('Enter button text', 'axil-elements'),
                'label_block' => true,
                'condition' => [
                    'axil_' . $control_id . '_show' => 'yes'
                ],
            ]
        );
    if ($archive) {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Link Type', 'axil-elements'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '1' => 'Custom Link',
                    '2' => 'Internal Page',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' link', 'axil-elements'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Select ' . $control_name . ' Page', 'axil-elements'),
                'type' => Controls_Manager::SELECT2,
                'label_block' => true,
     ...
     * @return [type]               [description]
     */
    protected function axil_link_controls2($control_id = 'button', $control_name = 'Button', $default = 'Read More', $archive = false, $pagination = false )
    {
    ...
    protected function axil_link_controls_style($control_id = 'button_style', $control_name = 'Button', $control_selector = 'a', $default_size = 'btn-large', $default_style = 'btn-solid')
    {
        ...
        // Normal State Tab
        $this->start_controls_tab('axil_' . $control_id . '_btn_normal', ['label' => esc_html__('Normal', 'axil-elements')]);

        $this->add_control(
            'axil_' . $control_id . '_btn_normal_text_color',
            [
                'label' => esc_html__('Text Color', 'axil-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} ' . $control_selector . '' => 'background: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Color', 'axil-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        // Hover State Tab
        $this->start_controls_tab('axil_' . $control_id . '_btn_hover', ['label' => esc_html__('Hover', 'axil-elements')]);
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} ' . $control_selector . '::after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} ' . $control_selector . ':hover' => 'border-color: {{VALUE}};',
    ...
    protected function axil_columns($control_id = 'columns_options', $control_name = 'Select Columns', $default_for_lg = '4', $default_for_md = '6', $default_for_sm = '6', $default_for_all = '12'){
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Desktop', 'axil-elements' ),
                'description' => esc_html__( 'Screen width equal to or greater than 992px', 'axil-elements' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'axil-elements' ),
                    6 => esc_html__( '2 Columns', 'axil-elements' ),
                    4 => esc_html__( '3 Columns', 'axil-elements' ),
                    3 => esc_html__( '4 Columns', 'axil-elements' ),
                    5 => esc_html__( '5 Columns (col-5)', 'axil-elements' ),
                    2 => esc_html__( '6 Columns', 'axil-elements' ),
                    1 => esc_html__( '12 Columns', 'axil-elements' ),
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Laptop', 'axil-elements' ),
                'description' => esc_html__( 'Screen width equal to or greater than 768px', 'axil-elements' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'axil-elements' ),
                    6 => esc_html__( '2 Columns', 'axil-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Tablet', 'axil-elements' ),
                'description' => esc_html__( 'Screen width equal to or greater than 576px', 'axil-elements' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'axil-elements' ),
                    6 => esc_html__( '2 Columns', 'axil-elements' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'axil-elements' ),
                'description' => esc_html__( 'Screen width less than 576px', 'axil-elements' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'axil-elements' ),
                    6 => esc_html__( '2 Columns', 'axil-elements' ),
