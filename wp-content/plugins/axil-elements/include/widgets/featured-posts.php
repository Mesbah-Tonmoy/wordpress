 ...
 * @package abstrak
 */
if( !class_exists('abstrak_featured_posts') ){
    class abstrak_featured_posts extends WP_Widget{
        /**
        ...
        function __construct(){
            ...
            $widget_options = array(
                'description'                   => esc_html__('abstrak: Featured posts here', 'axil-elements'),
                'customize_selective_refresh'   => true,
            );

            parent:: __construct('abstrak_featured_posts', esc_html__( 'abstrak: Featured posts', 'axil-elements'), $widget_options );
        ...
        public function widget($args, $instance){
            ...
            $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Featured posts','axil-elements' );
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id( 'only_video_post' )); ?>"><?php echo esc_html__( 'Display Only Video Post?','axil-elements' ); ?></label>
            </p>
            <?php
        }
    }
...
function abstrak_featured_posts(){
    register_widget('abstrak_featured_posts');
}
add_action('widgets_init','abstrak_featured_posts');
