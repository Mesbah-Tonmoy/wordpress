 ...
 * @package abstrak
 */
if( !class_exists('axil_Recent_Post') ){
    class axil_Recent_Post extends WP_Widget{
        /**
        ...
        function __construct(){
            ...
            $widget_options = array(
                'description'                   => esc_html__('Abstrak: Recent post here', 'axil-elements'),
                'customize_selective_refresh'   => true,
            );

            parent:: __construct('axil_Recent_Post', esc_html__( 'Abstrak: Recent Post', 'axil-elements'), $widget_options );
        ...
        $title          = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts','axil-elements' );        
                  ...
                  <div class="single-post">     
                    ...
                    <?php if ( has_post_thumbnail()): ?>
                        <div class="post-thumbnail thumbnail">
                            <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'axil-thumbnail-sm' ); ?></a>
                        </div>
                    <?php endif ?> 
    ...
    ?>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_item' )); ?>"><?php echo esc_html__( 'No. of Item of posts to show:','axil-elements' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'num_title_word' )); ?>"><?php echo esc_html__( 'Title Word','axil-elements' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>"><?php echo esc_html__( 'Display post date?','axil-elements' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_read_time' )); ?>"><?php echo esc_html__( 'Display Read Time?','axil-elements' ); ?></label>
        </p>
    <?php
        }
    }
...
function axil_Recent_Post(){
    register_widget('axil_Recent_Post');
}
add_action('widgets_init','axil_Recent_Post');
