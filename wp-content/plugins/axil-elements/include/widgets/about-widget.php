...
if( !class_exists('abstrak_Info_Widget') ){
    class abstrak_Info_Widget extends WP_Widget{
    	/**
        ...
        function __construct(){
            ...
            $widget_options = array(
                'description'                   => esc_html__('abstrak: Info here', 'axil-elements'),
                'customize_selective_refresh'   => true,
            );

            parent:: __construct('abstrak_Info_Widget', esc_html__( 'abstrak: Info', 'axil-elements'), $widget_options );
                ...
                <div class="address">
                    ...
                    <?php endif ?>
                        <?php if (!empty($address)): ?>
                            <p><span><?php esc_html_e('A.', 'axil-elements'); ?></span> <span class="address-info"><?php echo wp_kses_post($address); ?></span></p>
                        <?php endif ?>
                        <?php if (!empty($email)): ?>
                            <p><span><?php esc_html_e('E.', 'axil-elements'); ?></span> <span class="address-info"><a href="mailto:<?php echo esc_html($email); ?>"><?php echo esc_html($email); ?></a></span></p>
                        <?php endif ?>
                        <?php if (!empty($phone)):
                            $number = trim( preg_replace( '/[^\d|\+]/', '', $phone ) );
                            ?>
                            <p><span><?php esc_html_e('T.', 'axil-elements'); ?></span> <span class="address-info"><a href="tel:<?php echo esc_attr($number); ?>"><?php echo esc_html($phone); ?></a></span></p>
                        <?php endif ?>
                </div>
            </div>
        	<?php
        ...
        public function form($instance){ 
        	...
        	?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html__('Title:' ,'axil-elements') ?></label>
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				<button class="button button-primary author_info_image">
					<?php esc_html_e('Upload Logo', 'axil-elements'); ?>
				</button>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php echo esc_html__('Content:' ,'axil-elements') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html__('Address:' ,'axil-elements') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php echo esc_html__('Email:' ,'axil-elements') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php echo esc_html__('Phone:' ,'axil-elements') ?></label>
...
function abstrak_Info_Widget(){
    register_widget('abstrak_Info_Widget');
}
add_action('widgets_init','abstrak_Info_Widget');